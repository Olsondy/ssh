...
<div class="panel panel-default dy-panel">
	<div class="panel-heading">
		<h3 class="panel-title">
			<i class="fa fa-tags fa-lg"></i>班级管理
		</h3>
	</div>
	<div class="panel-body">
		<form id="searchStudentForm" class="dy-form-horizontal">
			<div class="row">
				...
				<div class="form-group col-sm-6 col-md-6 col-lg-3">
					 <div class="input-group input-group-sm">
                        <span class="input-group-addon">教师</span> <input type="text" class="form-control input-sm"
	...
	<!-- 表格  -->
	<table id="studentTable" class="table table-hover dy-dataTable responsive">
		<thead>
			<tr>
				<th>所在班级</th>
				<th>学生姓名</th>
...
<script src="<c:url value='/resources/js/DY/js/classes.js'></c:url>" type="text/javascript"></script>
